...
<?php 
  global $user;
  $account_role = user_load($user->uid);
  $print_roles = '';
  foreach ($account_role->roles as $role)
  {
...
?>
<body id="<?php print $body_id; ?>" class="<?php print $body_classes; ?> <?php print str_replace(' ','',$print_roles); ?>">
                          ...
                          <div id="content-region-inner" class="content-region-inner inner">
                            ...
                            <div id="content-inner" class="content-inner block">
                              <div id="content-inner-inner" class="content-inner-inner inner">
                                <?php if ($title): ?>
                                <h1 class="title"><?php print str_replace("create", "Toevoegen van ", strtolower($title)); // Very, very nasty quick little hack - where is this Create coming from? ?></h1>
                                <?php endif; ?>
                                <?php if ($content): ?>
...
$(".a11 select option:eq(0)").html('Nee');
$(".a1 select option:eq(0)").html('Nee');
$(".a11 select option:eq(1)").html('Ja');
$(".a1 select option:eq(1)").html('Ja'); 
$("tr.row10 td:eq(1)").html($("tr.row10 td:eq(1)").html().replace("Voldoende","Ja"));
$("tr.row10 td:eq(1)").html($("tr.row10 td:eq(1)").html().replace("Onvoldoende","Nee"));
$("tr.row11 td:eq(1)").html($("tr.row11 td:eq(1)").html().replace("Voldoende","Ja"));
$("tr.row11 td:eq(1)").html($("tr.row11 td:eq(1)").html().replace("Onvoldoende","Nee"));
</script>
